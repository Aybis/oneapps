...
<div class="row animated fadeInDown">
    <div class="col-sm-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
            <div class="panel-heading panel-heading-divider">Form Create
            ...
            <div class="panel-body">
                <form method="post" class="animated fadeIn delay-1s" data-parsley-validate=""
                    novalidate=" action="" enctype=" multipart/form-data"> @csrf <div class="box-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group xs-pt-10 {{ $errors->has('id_pelanggan') ? 'has-error': ''}}">
                                ...
                                <input type="text" placeholder="ID123XXX" parsley-trigger="change" id="id_pelanggan"
                                    name="id_pelanggan" class="form-control parsley-error" autofocus>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group xs-pt-10">
                                ...
                                <input type="text" placeholder="321666XXX" id="no_meter" name="no_meter"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group xs-pt-10">
                                ...
                                <input type="text" placeholder="PT TELKOM" id="nama_pelanggan" name="nama_pelanggan"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group xs-pt-10">
                                ...
                                <textarea name="alamat_pelanggan" id="alamat_pelanggan" class="form-control"
                                    placeholder="JALAN GATOT SUBROTO KAV.52"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group xs-pt-10">
                            ...
                            <div class="form-group xs-pt-10">
                                ...
                                <select name="witel" class="select2" id="witel" data-placeholder="Pilih Witel">
                                    ...
                                    <option value="{{ $item->witel }}"
                                        {{  (old('witel') == $item->witel) ? 'selected' : ''}}>{{ $item->witel }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group xs-pt-10">
                                ...
                                <select name="kota" class="select2" id="kota" data-placeholder="Pilih Kota">
                                    ...
                                    <option value="{{ $item->kota }}"
                                        {{  (old('kota') == $item->kota) ? 'selected' : ''}}>{{ $item->kota }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group xs-pt-10">
                                ...
                                <select name="provinsi" class="select2" id="provinsi" data-placeholder="Pilih Provinsi">
                                    @foreach ($provinsi as $item)
                                    <option value="{{ $item->provinsi }}"
                                        {{  (old('provinsi') == $item->provinsi) ? 'selected' : ''}}>
                                        {{ $item->provinsi }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group xs-pt-10">
                                ...
                                <select name="area_pins" id="area_pins" class="select2"
                                    ...
                                    <option value="{{ $item->area_pins }}"
                                        {{  (old('area_pins') == $item->area_pins) ? 'selected' : ''}}>
                                        {{ $item->area_pins }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group xs-pt-10">
                                ...
                                <select name="divre" class="select2" id="divre" data-placeholder="Pilih DivRe">
                                    ...
                                    <option value="{{ $item->divre }}"
                                        {{  (old('area_pins') == $item->divre) ? 'selected' : ''}}>
                                        {{ $item->divre }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group xs-pt-10">
                                ...
                                <select name="unitup" class="select2" id="unitup" data-placeholder="Pilih Unit Up">
                                    ...
                                    <option value="{{ $item->unitup }}"
                                        {{  (old('unitup') == $item->unitup) ? 'selected' : ''}}>{{ $item->unitup }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group xs-pt-10">
                                ...
                                <select name="tipe" class="select2" id="tipe" data-placeholder="Pilih Tipe">
                                    ...
                                    <option value="{{ $item->tipe }}"
                                        {{  (old('tipe') == $item->tipe) ? 'selected' : ''}}>{{ $item->tipe }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group xs-pt-10">
                                ...
                                <textarea name="alamat_unitup" id="alamat_unitup" class="form-control"
                                    placeholder="ID EKSISTNG DESEMBER 19.690 ID (PASCABAYAR : 18.490 ID, PRABAYAR : 1.200 ID)"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group xs-pt-10">
